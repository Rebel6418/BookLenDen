          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            >
              <svg className={`w-6 h-6 transition-colors ${
                isActive('/orders') ? 'text-blue-600' : 'text-gray-600 group-hover:text-blue-600'
            ...
            {token ? (
                    ...
                    <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-premium border border-gray-100 overflow-hidden z-20">
                      ...
                      <div className="p-2 border-t border-gray-100">
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 hover:bg-red-50 rounded-xl transition-all text-red-600 font-medium"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                to="/login"
                className="relative px-6 py-2.5 overflow-hidden group ml-2"
              >
                ...
                <span className="relative text-blue-600 group-hover:text-white font-bold transition-colors">
                  Login
                </span>
              </Link>
            )}
            ...
            {token ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left px-4 py-3 hover:bg-red-50 rounded-xl text-red-600 font-medium"
                >
                  🚪 Logout
                </button>
              </>
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="block w-full px-6 py-4 border-2 border-blue-600 text-blue-600 rounded-xl font-bold text-center"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Login
                </Link>
